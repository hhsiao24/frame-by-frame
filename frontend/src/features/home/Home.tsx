  ...
  return (
    <div className="flex flex-col w-screen min-h-screen items-center px-8 pt-32 gap-4 bg-stone-100">
      ...
      <P className="text-center max-w-xl">
        ...
        Snap, pose, and create memories with our interactive props 🎭, instant prints 🖼️, and fun filters 🎨. With <b
        className="text-black">Frame by Frame</b>, every picture is a new chapter in your celebration! 🎉 It’s the
